...
CREATE DATABASE IF NOT EXISTS grano_click_db;
USE grano_click_db;
...
-- Insertar roles básicos (Senior Touch: Evita que la app falle por falta de roles)
INSERT IGNORE INTO tipos_usuario (tipo_usuario_id, nombre, descripcion) VALUES (1, 'Admin', 'Administrador del sistema'), (2, 'Cliente', 'Usuario final');
...
CREATE TABLE IF NOT EXISTS contactos(
    ...
    telefono VARCHAR(10),
    mensaje TEXT,
    estado ENUM('leido','resuelto','en proceso') NOT NULL DEFAULT 'leido',
    nota VARCHAR(300),
