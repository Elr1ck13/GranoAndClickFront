  ...
  function actualizarNavbar() {
    ...
    if (userIsAuthenticated) {
      ...
      if (userId && userId.startsWith('AD')) {
        adminLink = `<li class="nav-item admin-link">
    <a class="nav-link text-danger fw-bold" href="${formularioCreacion}">Creación Producto</a>
</li>`;
      }

      navBar = `<nav class="navbar navbar-dark navbar-expand-lg mt-2">
        ...
        <div class="collapse navbar-collapse" id="mainNavbarContent">
            ...
            <ul class="navbar-nav d-flex">
                ...
                <li class="nav-item me-3">
                    <a class="btn btn-sm btn-warning" onclick="logOut()" href="#">Cerrar Sesión</a>
                </li>
